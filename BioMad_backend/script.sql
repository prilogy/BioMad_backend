...
CREATE TABLE "Lab" (
    ...
    CONSTRAINT "FK_Lab_City_CityId" FOREIGN KEY ("CityId") REFERENCES "City" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "CityTranslation" (
    ...
    "Name" text NULL,
    "BaseEntityId" integer NOT NULL,
    CONSTRAINT "PK_CityTranslation" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_CityTranslation_City_BaseEntityId" FOREIGN KEY ("BaseEntityId") REFERENCES "City" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_CityTranslation_Cultures_CultureId" FOREIGN KEY ("CultureId") REFERENCES "Cultures" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "LabTranslation" (
    ...
    "Address" text NULL,
    "BaseEntityId" integer NOT NULL,
    CONSTRAINT "PK_LabTranslation" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_LabTranslation_Lab_BaseEntityId" FOREIGN KEY ("BaseEntityId") REFERENCES "Lab" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_LabTranslation_Cultures_CultureId" FOREIGN KEY ("CultureId") REFERENCES "Cultures" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "MemberAnalyzes" (
    ...
    CONSTRAINT "FK_MemberAnalyzes_Lab_LabId" FOREIGN KEY ("LabId") REFERENCES "Lab" ("Id") ON DELETE RESTRICT,
...
VALUES (3, 1, 1, 'Microns - lalalalalala alal', 'Microns');
INSERT INTO "BiomarkerTypeTranslation" ("Id", "BaseEntityId", "CultureId", "Description", "Name")
VALUES (2, 1, 2, 'гармон лалал ывфв', 'Гармоны');
INSERT INTO "BiomarkerTypeTranslation" ("Id", "BaseEntityId", "CultureId", "Description", "Name")
VALUES (4, 1, 2, 'Микроны лалалала лалалала ла', 'Микроны');
INSERT INTO "BiomarkerTypeTranslation" ("Id", "BaseEntityId", "CultureId", "Description", "Name")
...
CREATE INDEX "IX_CityTranslation_BaseEntityId" ON "CityTranslation" ("BaseEntityId");

CREATE INDEX "IX_CityTranslation_CultureId" ON "CityTranslation" ("CultureId");
...
CREATE INDEX "IX_Lab_CityId" ON "Lab" ("CityId");

CREATE INDEX "IX_LabTranslation_BaseEntityId" ON "LabTranslation" ("BaseEntityId");

CREATE INDEX "IX_LabTranslation_CultureId" ON "LabTranslation" ("CultureId");

CREATE INDEX "IX_MemberAnalyzes_LabId" ON "MemberAnalyzes" ("LabId");
...
VALUES ('20201213170741_Init', '3.1.9');
